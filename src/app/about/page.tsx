...
export const metadata: Metadata = {
  title: "About | Baiching - Frontend Developer",
  description:
    "Learn more about Baiching, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
    "About Baiching",
    "Frontend Developer",
    "React Developer",
