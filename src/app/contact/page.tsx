...
export const metadata: Metadata = {
  title: "Contact | Baiching - Frontend Developer",
  description:
    "Get in touch with Baiching for web development projects, collaborations, and job opportunities.",
  keywords: [
    "Contact Baiching",
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4 animate-fade-in-up delay-700">
                {/* Email */}
                <Link
                  href="mailto:Baichingnakum07@gmail.com"
