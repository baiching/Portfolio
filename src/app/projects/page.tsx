...
export const metadata: Metadata = {
  title: "Projects | Baiching - Frontend Developer",
  description:
    "Explore projects developed by Baiching, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
